...
class QRCodeScanViewController: UIViewController {
    ...
    static func create() -> QRCodeScanViewController {
        let storyboard = UIStoryboard(name: Storyboard.main, bundle: nil)
        return storyboard.instantiateViewController(withIdentifier: "QRCodeScanViewControllerID") as! QRCodeScanViewController
    }
...
extension QRCodeScanViewController:  MZFormSheetPresentationContentSizing {
